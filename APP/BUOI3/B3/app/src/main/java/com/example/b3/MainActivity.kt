...
//                    Toast.makeText(this@MainActivity, "$name", Toast.LENGTH_SHORT).show()
                    ...
                    if(index==3){
                        ...
                        if (arrEmployees.size == 0) {
                            ...
                            arrPhone.add(phone)
                            flag == 0
//                            Toast.makeText(this@MainActivity, "1+$arrEmployees", Toast.LENGTH_SHORT).show()
                        }else {
                            for (i in 0..arrEmployees.size - 1) {
                                if (arrEmployees[i].career == career && phone !in arrPhone) {
                                    arrEmployees[i].infors.add(Infors(id, name, phone))
//                                    Toast.makeText(this@MainActivity, "Phone", Toast.LENGTH_SHORT).show()
                                    arrPhone.add(phone)
                                }
                                if (flag == 1 && phone !in arrPhone) {
                                    ...
                                    arrPhone.add(phone)
                                    flag = 0
//                                    Toast.makeText(this@MainActivity, "3+$arrEmployees", Toast.LENGTH_SHORT).show()
                                }
                            }
                        }
                    }
