...
class MainActivity : AppCompatActivity() {
    ...
    val brandDt = arrayOf("Iphone 5", "SamSung S III", "HTC", "Windows Phone Surface", "Nokia 1100", "Q-Mobile")
    ...
    val imgDt = arrayOf(R.drawable.iphone, R.drawable.samsung, R.drawable.htc,
